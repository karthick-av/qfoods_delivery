...
class PickedOrdersDeliveredScreen extends StatefulWidget {
  final int status_id;
  const PickedOrdersDeliveredScreen({super.key, required this.status_id});

  @override
  State<PickedOrdersDeliveredScreen> createState() => _PickedOrdersDeliveredScreenState();
}

class _PickedOrdersDeliveredScreenState extends State<PickedOrdersDeliveredScreen> {
...
try{
 ...
 ordersProvider.AddRestaurantDeliveredOrders(_orders);
...
try{
 ...
 ordersProvider.AddRestaurantDeliveredOrders([...ordersProvider.DeliveredRestaurantOrders, ..._orders]);
       //  orders=  [...orders, ..._orders];
...
void dispose(){
  ...
  Widget build(BuildContext context) {
   final orders = Provider.of<OrdersProvider>(context, listen: true).DeliveredRestaurantOrders;
