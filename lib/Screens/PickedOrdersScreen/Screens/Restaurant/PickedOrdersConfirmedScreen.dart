...
class PickedOrdersConfirmedScreen extends StatefulWidget {
  final int status_id;
  const PickedOrdersConfirmedScreen({super.key, required this.status_id});

  @override
  State<PickedOrdersConfirmedScreen> createState() => _PickedOrdersConfirmedScreenState();
}

class _PickedOrdersConfirmedScreenState extends State<PickedOrdersConfirmedScreen> {
...
try{
 ...
 ordersProvider.AddRestaurantConfirmedOrders(_orders);
...
try{
 ...
 ordersProvider.AddRestaurantConfirmedOrders([...ordersProvider.ConfirmedRestaurantOrders, ..._orders]);
       //  orders=  [...orders, ..._orders];
...
void dispose(){
  ...
  Widget build(BuildContext context) {
   final orders = Provider.of<OrdersProvider>(context, listen: true).ConfirmedRestaurantOrders;
