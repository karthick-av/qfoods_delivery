...
import 'package:qfoods_delivery/Screens/ViewOrder/ViewGroceryOrderScreen.dart';
import 'package:qfoods_delivery/Screens/ViewOrder/ViewOrderScreen.dart';
...
class GroceryOrderCard extends StatelessWidget {
  final GroceryOrderModel? order;
  const GroceryOrderCard({super.key, required this.order});
 ...
 String formatted = "";
  ...
  if(parsedDate != ""){
    ...
    formatted =  parsedDate != "" ? formatter.format(parsedDate as DateTime) : '';
                        ...
                        context,
                        MaterialPageRoute(builder: (context) => 
                       ViewGroceryOrderScreen(orderDetail: order!)),
                      );
                          },
                          child: Container(
                            margin: const EdgeInsets.only(top: 10),
